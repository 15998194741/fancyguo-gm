<template>
    <div class="container">
        ...
        <a-row>
            ...
            <a-col v-show="svalue == 'customQQ'" :span="16">
                <a-input-search
                    v-model="qq"
        ...
        <div :key="svalue" class="hello">
            ...
            >
                ...
                >
                   ...
                   <canvas :id="'mycnavas_'+element.id" class="item" :sortid="element.id" width="100" height="100"></canvas>
                </li>
            </draggable>
        </div>
        <div>
