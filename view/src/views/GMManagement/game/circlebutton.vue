<template>
  <div class="circleButton">
    <div class="menu" :class="{ active: menuTrue, 'not-allowed-event': animation }">
      <div :ref="refName"  @click="menuTrue = !menuTrue">
        <span class="line"></span>
      </div>
      <div ref="icons" class="icons" >
        <div class="rotater" >
          <div class="btn btn-icon backclass"  @click="ChangeClick('edit')" >
            <i class="fa el-icon-edit"></i>
          </div>
        </div>
        <div  class="rotater">
          <div class="btn btn-icon backclass"  @click="ChangeClick('delete')" >
...
export default {
  ...
  methods: {
    async ChangeClick(val) {
      switch (val) {
        case 'edit':
          gameIndex.$emit('ChangeClick', { index: this.refName, change: true });
          break;
        case 'delete':
          gameIndex.$emit('ChangeClick', {
            index: this.refName,
            change: false
          });
          break;
  ...
  async mounted() {
    ...
    // this.$refs.icons.addEventListener('transitionend', () => {
    //   this.animationEnd = !this.menuTrue;
    // });
  },
  async created() {}
};
